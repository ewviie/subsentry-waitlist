...
export function PhoneFrame() {
  return (
    <div className="relative mx-auto w-[220px] sm:w-[235px] lg:mx-0 lg:ml-auto lg:w-[250px]">
      <div className="relative rounded-[2rem] bg-neutral-900 p-2.5 shadow-2xl shadow-black/30">
        {/* Side buttons */}
        ...
        <div className="relative overflow-hidden rounded-[1.5rem] bg-black">
          <Image
            ...
            alt="The SubSentry subscriptions list on a phone — Adobe Creative Cloud flagged as high cost, plus iCloud+ and Spotify"
            width={780}
            height={1922}
            priority
            className="w-full"
